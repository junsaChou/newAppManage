    ...
    <el-card shadow="always">
      ...
      >
        <el-form-item label="姓名">
          <el-input v-model="listQuery.user" placeholder="姓名" />
        </el-form-item>
        <el-form-item label="手机">
          <el-input v-model="listQuery.phone" placeholder="手机" />
        </el-form-item>
        <el-form-item label="身份证号">
          <el-input v-model="listQuery.phone" placeholder="身份证号" />
        </el-form-item>
        <el-form-item label="来源渠道">
          <el-input v-model="listQuery.phone" placeholder="来源渠道" />
        </el-form-item>
        <el-form-item label="账户状态">
          <el-select v-model="listQuery.married" placeholder="审核状态">
        ...
        <el-form-item label="公司名称">
          <el-input v-model="listQuery.company" placeholder="公司名称" />
        </el-form-item>
        <el-form-item label="认证城市">
          <el-input v-model="listQuery.company" placeholder="认证城市" />
        </el-form-item>
        <el-form-item label="日期范围">
          <el-date-picker
            v-model="listQuery.dataMap"
            type="datetimerange"
        ...
        <el-form-item label="用户状态">
          <el-select v-model="listQuery.proofCode" placeholder="用户状态">
            <el-option value label="全部" />
            <el-option :value="0" label="审核" />
            <el-option :value="1" label="待审核" />
            <el-option :value="2" label="未认证" />
            <el-option :value="3" label="审核成功" />
          </el-select>
        </el-form-item>
        <el-form-item label="备注">
        <el-input v-model="listQuery.remarks" placeholder="请填写" />
      </el-form-item>
        <el-form-item>
