  ...
  <div class="table-classic-wrapper">
    <el-card v-show="rewardListForm.flag">
      ...
      <div class="control-btns">
        ...
        <el-button type="primary" @click="rewardListForm.flag = false">更改奖励金额</el-button>
      </div>
      <!-- 表格栏 -->
      <el-table
        ref="multipleTable"
      ...
      >
        ...
        <el-table-column show-overflow-tooltip prop="activitySorce" label="充值金额" align="center" />
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      this.formVisibleList.title = "修改充值金额";
    ...
    handleDispatch(index, row) {
      this.$confirm("确定发放本次充值活动奖励", "发放奖励", {
