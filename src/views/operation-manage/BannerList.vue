  ...
  data() {
    return {
      ...
      listQuery: {
       ...
       searchFields: [
        { span: 2, prop: 'title', name: '广告名称', placeholder: '广告名称' },
        ...
        { span: 6, type: 'pickerOptionsPicker', name:'日期范围', placeholder: '日期范围', prop: 'dateTime',pickerOptions: this.pickerOptions},
      
        { span: 2, prop: 'bannerType',name:'广告类型', placeholder: '请输入',  type: 'select',
          options: [
                    { label: '全部', value: null },
