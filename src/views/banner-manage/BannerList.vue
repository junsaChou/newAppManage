    ...
    <el-card shadow="always">
      ...
      >
        ...
        <el-table-column
          ...
          sortable
        />
        <el-table-column show-overflow-tooltip prop="title" label="banner名称" align="center" />
        <el-table-column show-overflow-tooltip  label="banner图示" align="center" >
        ...
        <el-table-column show-overflow-tooltip label="banner状态 " align="center">
      ...
      >
        <el-form ref="dialogForm" :model="dialogForm" :rules="formRules" label-width="110px">
          <el-form-item label="banner名称：" prop="title" maxlength="16">
            <el-input v-model="dialogForm.title" />
          </el-form-item>
          <el-form-item label="排序：" prop="bannerSort" maxlength="2">
